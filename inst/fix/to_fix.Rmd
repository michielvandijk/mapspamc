...
- run_spamc(): If combine_inputs() is not run it returns an error. Probably all functions return an error if the previous step is not run. Proper error warnings should be added
