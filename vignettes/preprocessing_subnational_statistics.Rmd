...
3. A file with  **production system area shares (fs)** (not percentages!) for each subnational administrative unit at the national level (same format as the cropping intensity information).
