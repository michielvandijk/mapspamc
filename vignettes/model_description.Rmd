...
`mapspamc` includes two types of models: (1) Minimization of cross-entropy, which is used by SPAM [@You2006; @You2009; @You2014a; @Yu2020] and the maximization of fitness score, which was developed by @VanDijk2022b.  
